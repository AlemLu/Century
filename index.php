...
<body>
   ...
   <header>
       ...
       <div class="navegacion">
           ...
           <nav>
               <ul class="menu">
                   <li><a href="javascript:void(0);" style="color: #000;"><span class="glyphicon glyphicon-home"></span> Inicio</a></li>
   ...
   <!-- Cuerpo -->
    ...
    <div class="contenedor" style="background: #f2f2f2;">        
        <div id="c-slider">
            <div id="slider">
                <section>
                ...
                <section>
                    ...
                    <p>Proporcionar a sus clientes seguridad, vigilancia y control en el momento y lugar que sea requerido, contribuyendo a mantener el estado de confianza y seguridad que permita a sus clientes desarrollar sus actividades en forma normal.</p>
                </section>
                <section>
    ...
    <div class="row contenedor">
		...
		<hr>
		    <div class="col-xs-8 col-sm-8 col-md-8">
		        ...
		        <span class="glyphicon glyphicon-ok letra-nueper"> Lucha contra incendios</span><br>
		        <span class="glyphicon glyphicon-ok letra-nueper"> Manejo y uso de extintores</span><br>
            </div><br><br><br><br>
            <div class="col-xs-4 col-sm-4 col-md-4">
                <img class="img-nueper" src="images/personal.png"><br><br>
            </div>
    </div>
    <!-- Nuestro Personal Fin -->
         
    <!-- Aliados -->
	<div class="row contenedor" style="background: #f2f2f2;">
	    <h1 class="century-h1">ALIADOS</h1>
	    <hr>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 portafolio-item">
		        <a href="http://www.munitrujillo.gob.pe/noticiasmpt/categorias/seguridadciudadana" target="_blank"><center><img class="img-aliados" src="images/segciud.png"></center></a>
		        <div class="portafolio-text">
                    <h1>Serenazgo</h1>
                </div>
		    </div>
    ...
    <div class="contenedor">
        <h1 class="century-h1">CLIENTES</h1>
        <hr>
        <center><p class="letra-clientes"> Ellos nos respaldan.</p></center>
         <section class="center slider" style="width:98%;">
            <div>
                <img src="images/clientes/cliente1.jpg" width="80%" height="80%">
            </div>
                <div>
                <img src="images/clientes/cliente2.jpg" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente3.jpg" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente4.jpg" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente5.jpg" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente6.jpg" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente7.jpg" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente8.jpg" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente9.jpg" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente10.jpg" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente11.jpg" title="" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente12.jpg" title="" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente13.jpg" title="" width="80%" height="80%">
            </div>
            <div>
              <img src="images/clientes/cliente14.jpg" title="" width="80%" height="80%">
            </div>
        </section>
    </div>
